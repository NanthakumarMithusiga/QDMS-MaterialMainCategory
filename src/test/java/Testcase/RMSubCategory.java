...
public class RMSubCategory extends initial {
...
// Material Source -----------------------------------------------------------------------------
        try {
            driver.findElement(By.xpath("//div[@name='source']//div[@class='ant-select-selector']")).click();
            Thread.sleep(1000);
            driver.findElement(
                    By.cssSelector("div[title='" + MaterialSource + "'] div[class='ant-select-item-option-content']"))
                    .click();
            Thread.sleep(3000);
        } catch (Exception e) {
...
//// -----------------------------------------------------------------------------------------------
        ...
        try {
            ...
            Thread.sleep(2000);
            SavedMaterialSource = driver.findElement(By.xpath("//div[@class='ant-popover-inner-content']")).getText();
...
// !! Done
        ...
        //********************************************************************************************
        //When Select the Raw Material sub category, need to view source field and able to enter value
        //********************************************************************************************
        
        
        testcase = extent.createTest("STEP-01-Click AddMaterialMainCategory button");
        testcase = extent.createTest("STEP-02-Select the RMField in subcategory");
        testcase = extent.createTest("STEP-03-When Select the Raw Material sub category, need to view source field and able to enter value");
        
        //****************************************************************************************************
        //STEP-03-When Select the Raw Material sub category, need to view source field and able to enter value
        //****************************************************************************************************
        
        if (SavedMaterial.equals(Material)) {
            if (SavedMaterialSource.equals(MaterialSource)) {
                TestCasePrint(
                        "When Select the Raw Material sub category, need to view source field and able to enter value",
