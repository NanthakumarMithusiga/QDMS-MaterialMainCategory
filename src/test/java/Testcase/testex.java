...
public class testex extends initial {
...
// -------------------------------------------------------------------------------------------------
        try {
            driver.findElement(By.xpath("//span[normalize-space()='Common']")).click();
            Thread.sleep(2000);
        } catch (Exception e) {
...
//// -----------------------------------------------------------------------------------------------
        try {
            driver.findElement(By.xpath("(//span[@class='ant-radio'])[2]")).click();
        } catch (Exception e) {
...
//// ----------------------------------------------------------------------------------------------
        try {
            driver.findElement(By.xpath("//div[contains(@name,'sbu')]")).click();
            Thread.sleep(2000);
